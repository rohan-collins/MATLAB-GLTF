...
face_idx=obj.addMaterial('baseColorFactor',C1);
% Add the material for the edge colour.
edge_idx=obj.addMaterial('baseColorFactor',C2);
...
obj=gltf.utilities.addAxes(obj,'baseRotation',[0 0 1;1 0 0;0 1 0],'axisIds',["x00";"0y0";"01z"],'gridIds',["xy0","x1z","1yz"],'backPlanes',["xy0","x1z","1yz"],'scaleFactor',5,'axis',h.Parent,'fontFile',"ARIALUNI_1.svg",'plotAspect',true,'dataAspect',true);
% Write the GLTF file.
obj.writeGLTF("histogram2.gltf");
