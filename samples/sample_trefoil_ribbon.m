...
gltf.addNode('mesh',gltf.addMesh(V*[0 0 1;1 0 0;0 1 0],'indices',F,'NORMAL',N*[0 0 1;1 0 0;0 1 0],'material',gltf.addMaterial('baseColorFactor',[0 1 0],'doubleSided',true)));
% Write the GLTF file.
gltf.writeGLTF("trefoil_ribbon.gltf");
