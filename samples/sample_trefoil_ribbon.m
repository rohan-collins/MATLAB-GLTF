...
R=0.607154708718215;
[F,V,~,N]=gltf.utilities.tubeplot(curve,'Radius',R,'Resolution',2,'FirstDerivative',first,'SecondDerivative',second,'ThirdDerivative',third,'Theta_0',pi/2);
% Create the GLTF object.
obj=gltf.GLTF();
% Add the mesh with faces, vertices, normals, and a new material.
obj.addNode('mesh',obj.addMesh(V*[0 0 1;1 0 0;0 1 0],'indices',F,'NORMAL',N*[0 0 1;1 0 0;0 1 0],'material',obj.addMaterial('baseColorFactor',[0 1 0],'doubleSided',true)));
% Write the GLTF file.
obj.writeGLTF("trefoil_ribbon.gltf");
