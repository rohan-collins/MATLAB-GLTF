...
R=0.607154708718215;
[F,V,~,N]=gltf.utilities.tubeplot(curve,'Radius',R,'Resolution',36,'FirstDerivative',first,'SecondDerivative',second,'ThirdDerivative',third,'Ends',false);
% Create the GLTF object.
obj=gltf.GLTF();
% Add the mesh with faces, vertices, normals, and a new material.
obj.addNode('mesh',obj.addMesh(V*[0 0 1;1 0 0;0 1 0],'indices',F,'NORMAL',N*[0 0 1;1 0 0;0 1 0],'material',obj.addMaterial('baseColorFactor',[0 0 1])));
% Write the GLTF file.
obj.writeGLTF("trefoil_tube.gltf");
