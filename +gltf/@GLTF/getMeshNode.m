function [node,library_geometries,library_controllers,node_list]=getMeshNode(obj,documentNode,library_geometries,library_controllers,node_id,node_list,normals,tangents,binormals)
    ...
    %
    mesh_idx=obj.nodes{node_id}.mesh+1;
    node=documentNode.createElement("node");
    node.setAttribute("id","node_"+string(node_id));
    for primitive_idx=1:numel(obj.meshes{mesh_idx}.primitives)
        subnode=documentNode.createElement("node");
        subnode.setAttribute("id","node_"+string(node_id)+"_"+string(primitive_idx));
        vertex_data=obj.getAccessor(obj.meshes{mesh_idx}.primitives{primitive_idx}.attributes.POSITION);
        faces_data=gltf.GLTF.fromTriangles(obj.getAccessor(obj.meshes{mesh_idx}.primitives{primitive_idx}.indices));
        if(isfield(obj.meshes{mesh_idx}.primitives{primitive_idx},'material') && isfield(obj.meshes{mesh_idx}.primitives{primitive_idx}.material,'doubleSided'))
            doubleSided=obj.materials{obj.meshes{mesh_idx}.primitives{primitive_idx}.material+1}.doubleSided;
        else
            doubleSided=false;
        end
        if(doubleSided)
        ...
        if(normals)
            normals_data=gltf.GLTF.faceNormals(faces_data,vertex_data);
        else
            normals_data=[];
        end
        ...
        tangents=and(tangents,or(isfield(obj.meshes{mesh_idx}.primitives{primitive_idx}.attributes,'TEXCOORD_0'),isfield(obj.meshes{mesh_idx}.primitives{primitive_idx}.attributes,'TANGENT')));
        if(tangents)
            if(isfield(obj.meshes{mesh_idx}.primitives{primitive_idx}.attributes,'TEXCOORD_0'))
                uv_data=obj.getAccessor(obj.meshes{mesh_idx}.primitives{primitive_idx}.attributes.TEXCOORD_0);
                [tangents_data,binormals_data]=gltf.GLTF.faceTangents(faces_data,vertex_data_old,uv_data);
                ...
                tv_data=obj.getAccessor(obj.meshes{mesh_idx}.primitives{primitive_idx}.attributes.TANGENT);
                ...
                nf_data=gltf.GLTF.faceNormals(faces_data,vertex_data_old);
                if(tangents)
                    tv_data=tv_data(:,1:3);
        ...
        if(isfield(obj.meshes{mesh_idx}.primitives{primitive_idx}.attributes,'COLOR_0'))
            c_data=obj.getAccessor(obj.meshes{mesh_idx}.primitives{primitive_idx}.attributes.COLOR_0);
        ...
        if(isfield(obj.nodes{node_id},'skin'))
        ...
        elseif(isfield(obj.meshes{mesh_idx}.primitives{primitive_idx},'targets'))
            instance_geometry=documentNode.createElement("instance_controller");
        ...
        if(isfield(obj.meshes{mesh_idx}.primitives{primitive_idx},'material'))
            ...
            instance_material.setAttribute("symbol","material_"+string(obj.meshes{mesh_idx}.primitives{primitive_idx}.material+1));
            instance_material.setAttribute("target","#material_"+string(obj.meshes{mesh_idx}.primitives{primitive_idx}.material+1));
        ...
        float_array.appendChild(documentNode.createTextNode(strip(sprintf(gltf.GLTF.formatSpec_float(),vertex_data'))));
        ...
        if(~isempty(normals_data))
            ...
            float_array.appendChild(documentNode.createTextNode(strip(sprintf(gltf.GLTF.formatSpec_float(),normals_data'))));
            source.appendChild(float_array);
            technique_common=documentNode.createElement("technique_common");
            accessor=documentNode.createElement("accessor");
        ...
        if(~isempty(tangents_data))
            ...
            float_array.appendChild(documentNode.createTextNode(strip(sprintf(gltf.GLTF.formatSpec_float(),tangents_data'))));
            source.appendChild(float_array);
            technique_common=documentNode.createElement("technique_common");
            accessor=documentNode.createElement("accessor");
        ...
        if(~isempty(binormals_data))
            ...
            float_array.appendChild(documentNode.createTextNode(strip(sprintf(gltf.GLTF.formatSpec_float(),binormals_data'))));
            source.appendChild(float_array);
            technique_common=documentNode.createElement("technique_common");
            accessor=documentNode.createElement("accessor");
        ...
        if(isfield(obj.meshes{mesh_idx}.primitives{primitive_idx}.attributes,'TEXCOORD_0'))
            ...
            float_array.appendChild(documentNode.createTextNode(strip(sprintf(gltf.GLTF.formatSpec_float(),uv_data'))));
            source.appendChild(float_array);
            technique_common=documentNode.createElement("technique_common");
            accessor=documentNode.createElement("accessor");
        ...
        if(isfield(obj.meshes{mesh_idx}.primitives{primitive_idx}.attributes,'COLOR_0'))
            ...
            float_array.appendChild(documentNode.createTextNode(strip(sprintf(gltf.GLTF.formatSpec_float(),c_data'))));
            source.appendChild(float_array);
            technique_common=documentNode.createElement("technique_common");
            accessor=documentNode.createElement("accessor");
        ...
        elseif(size(faces_data,2)==2)
            ...
            vcount.appendChild(documentNode.createTextNode(strip(sprintf(gltf.GLTF.formatSpec_integer(),vertices_count))));
            triangles.appendChild(vcount);
        end
        triangles.setAttribute("count",string(size(faces_data,1)));
        if(isfield(obj.meshes{mesh_idx}.primitives{primitive_idx},'material'))
            triangles.setAttribute("material","material_"+string(obj.meshes{mesh_idx}.primitives{primitive_idx}.material+1));
        end
        input=documentNode.createElement("input");
        ...
        p.appendChild(documentNode.createTextNode(strip(sprintf(gltf.GLTF.formatSpec_integer(),idx(:)'))));
        ...
        if(isfield(obj.meshes{mesh_idx}.primitives{primitive_idx},'targets'))
            for target_id=1:numel(obj.meshes{mesh_idx}.primitives{primitive_idx}.targets)
                vertex_data=obj.getAccessor(obj.meshes{mesh_idx}.primitives{primitive_idx}.targets{target_id}.POSITION);
                if(size(faces_data,2)>=3)
                    normals=true;
                else
                    normals=false;
            ...
            weights_data=gltf.GLTF.toMat(obj.meshes{mesh_idx}.weights);
            ...
            idref_array.appendChild(documentNode.createTextNode(strip(join("geometry_"+string(mesh_idx)+"_"+string(primitive_idx)+"_"+string((1:numel(obj.meshes{mesh_idx}.primitives{primitive_idx}.targets))')))));
            ...
            float_array.appendChild(documentNode.createTextNode(strip(sprintf(gltf.GLTF.formatSpec_float(),weights_data))));
            source.appendChild(float_array);
            technique_common=documentNode.createElement("technique_common");
            accessor=documentNode.createElement("accessor");
    ...
    if(isfield(obj.nodes{node_id},'skin'))
        skin_idx=obj.nodes{node_id}.skin+1;
        for primitive_idx=1:numel(obj.meshes{mesh_idx}.primitives)
            controller=documentNode.createElement("controller");
            ...
            IDREF_array.setAttribute("count",string(numel(obj.skins{skin_idx}.joints)));
            IDREF_array.appendChild(documentNode.createTextNode(strip(join("node_"+string(gltf.GLTF.toMat(obj.skins{skin_idx}.joints)+1)))));
            source.appendChild(IDREF_array);
            technique_common=documentNode.createElement("technique_common");
            accessor=documentNode.createElement("accessor");
            accessor.setAttribute("count",string(numel(obj.skins{skin_idx}.joints)));
            ...
            ibm_data=permute(obj.getAccessor(obj.skins{skin_idx}.inverseBindMatrices),[2 1 3]);
            source=documentNode.createElement("source");
            ...
            float_array.appendChild(documentNode.createTextNode(strip(sprintf(gltf.GLTF.formatSpec_float(),reshape(ibm_data,1,[])))));
            source.appendChild(float_array);
            technique_common=documentNode.createElement("technique_common");
            accessor=documentNode.createElement("accessor");
            ...
            weights_data=obj.getAccessor(obj.meshes{mesh_idx}.primitives{primitive_idx}.attributes.WEIGHTS_0)';
            vcount_data=sum(weights_data>0,1);
            joints_data=obj.getAccessor(obj.meshes{mesh_idx}.primitives{primitive_idx}.attributes.JOINTS_0)';
            ...
            float_array.setAttribute("count",string(numel(weights_data)));
            float_array.appendChild(documentNode.createTextNode(strip(sprintf(gltf.GLTF.formatSpec_float(),reshape(weights_data,1,[])))));
            source.appendChild(float_array);
            technique_common=documentNode.createElement("technique_common");
            accessor=documentNode.createElement("accessor");
            accessor.setAttribute("count",string(numel(weights_data)));
            ...
            vertex_weights.appendChild(input);
            vcount=documentNode.createElement("vcount");
            vcount.appendChild(documentNode.createTextNode(strip(sprintf(gltf.GLTF.formatSpec_integer(),vcount_data))));
            vertex_weights.appendChild(vcount);
            v=documentNode.createElement("v");
            v.appendChild(documentNode.createTextNode(strip(sprintf(gltf.GLTF.formatSpec_integer(),reshape([joints_data';weights_data_idx'],1,[])))));
