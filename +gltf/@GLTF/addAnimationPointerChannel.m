function channelstruct=addAnimationPointerChannel(obj,sampler,target_path)
    % Add an animation channel.
    %
    % ADDANIMATIONPOINTERCHANNEL(OBJ,SAMPLER,TARGET_PATH) creates and
    ...
    gltf.GLTF.validateStringWithIndex(target_path,possibilities,"idx");
    addExtension(obj,"KHR_animation_pointer");
