function material_idx=addMaterial(obj,varargin)
    % Add a physically-based rendering material.
    %
    % ADDMATERIAL(OBJ) adds an empty physically-based rendering material
    ...
    ips.addParameter('alphaMode',missing,@(x)gltf.GLTF.validateString(x,alphaMode_str_values));
    ...
    ips.addParameter('baseColorMagFilter',missing,@(x)gltf.GLTF.validateString(x,filter_str_values));
    ips.addParameter('baseColorMinFilter',missing,@(x)gltf.GLTF.validateString(x,filter_str_values));
    ips.addParameter('baseColorWrapS',missing,@(x)gltf.GLTF.validateString(x,wrap_str_values));
    ips.addParameter('baseColorWrapT',missing,@(x)gltf.GLTF.validateString(x,wrap_str_values));
    ...
    ips.addParameter('normalMagFilter',missing,@(x)gltf.GLTF.validateString(x,filter_str_values));
    ips.addParameter('normalMinFilter',missing,@(x)gltf.GLTF.validateString(x,filter_str_values));
    ips.addParameter('normalWrapS',missing,@(x)gltf.GLTF.validateString(x,wrap_str_values));
    ips.addParameter('normalWrapT',missing,@(x)gltf.GLTF.validateString(x,wrap_str_values));
    ...
    ips.addParameter('occlusionMagFilter',missing,@(x)gltf.GLTF.validateString(x,filter_str_values));
    ips.addParameter('occlusionMinFilter',missing,@(x)gltf.GLTF.validateString(x,filter_str_values));
    ips.addParameter('occlusionWrapS',missing,@(x)gltf.GLTF.validateString(x,wrap_str_values));
    ips.addParameter('occlusionWrapT',missing,@(x)gltf.GLTF.validateString(x,wrap_str_values));
    ...
    ips.addParameter('metallicRoughnessMagFilter',missing,@(x)gltf.GLTF.validateString(x,filter_str_values));
    ips.addParameter('metallicRoughnessMinFilter',missing,@(x)gltf.GLTF.validateString(x,filter_str_values));
    ips.addParameter('metallicRoughnessWrapS',missing,@(x)gltf.GLTF.validateString(x,wrap_str_values));
    ips.addParameter('metallicRoughnessWrapT',missing,@(x)gltf.GLTF.validateString(x,wrap_str_values));
    ...
    ips.addParameter('emissiveMagFilter',missing,@(x)gltf.GLTF.validateString(x,filter_str_values));
    ips.addParameter('emissiveMinFilter',missing,@(x)gltf.GLTF.validateString(x,filter_str_values));
    ips.addParameter('emissiveWrapS',missing,@(x)gltf.GLTF.validateString(x,wrap_str_values));
    ips.addParameter('emissiveWrapT',missing,@(x)gltf.GLTF.validateString(x,wrap_str_values));
    ...
    ips.addParameter('transmissionMagFilter',missing,@(x)gltf.GLTF.validateString(x,filter_str_values));
    ips.addParameter('transmissionMinFilter',missing,@(x)gltf.GLTF.validateString(x,filter_str_values));
    ips.addParameter('transmissionWrapS',missing,@(x)gltf.GLTF.validateString(x,wrap_str_values));
    ips.addParameter('transmissionWrapT',missing,@(x)gltf.GLTF.validateString(x,wrap_str_values));
    ...
    ips.addParameter('thicknessMagFilter',missing,@(x)gltf.GLTF.validateString(x,filter_str_values));
    ips.addParameter('thicknessMinFilter',missing,@(x)gltf.GLTF.validateString(x,filter_str_values));
    ips.addParameter('thicknessWrapS',missing,@(x)gltf.GLTF.validateString(x,wrap_str_values));
    ips.addParameter('thicknessWrapT',missing,@(x)gltf.GLTF.validateString(x,wrap_str_values));
    ...
    ips.addParameter('clearcoatMagFilter',missing,@(x)gltf.GLTF.validateString(x,filter_str_values));
    ips.addParameter('clearcoatMinFilter',missing,@(x)gltf.GLTF.validateString(x,filter_str_values));
    ips.addParameter('clearcoatWrapS',missing,@(x)gltf.GLTF.validateString(x,wrap_str_values));
    ips.addParameter('clearcoatWrapT',missing,@(x)gltf.GLTF.validateString(x,wrap_str_values));
    ...
    ips.addParameter('clearcoatRoughnessMagFilter',missing,@(x)gltf.GLTF.validateString(x,filter_str_values));
    ips.addParameter('clearcoatRoughnessMinFilter',missing,@(x)gltf.GLTF.validateString(x,filter_str_values));
    ips.addParameter('clearcoatRoughnessWrapS',missing,@(x)gltf.GLTF.validateString(x,wrap_str_values));
    ips.addParameter('clearcoatRoughnessWrapT',missing,@(x)gltf.GLTF.validateString(x,wrap_str_values));
    ...
    ips.addParameter('clearcoatNormalMagFilter',missing,@(x)gltf.GLTF.validateString(x,filter_str_values));
    ips.addParameter('clearcoatNormalMinFilter',missing,@(x)gltf.GLTF.validateString(x,filter_str_values));
    ips.addParameter('clearcoatNormalWrapS',missing,@(x)gltf.GLTF.validateString(x,wrap_str_values));
    ips.addParameter('clearcoatNormalWrapT',missing,@(x)gltf.GLTF.validateString(x,wrap_str_values));
    ...
    ips.addParameter('sheenColorMagFilter',missing,@(x)gltf.GLTF.validateString(x,filter_str_values));
    ips.addParameter('sheenColorMinFilter',missing,@(x)gltf.GLTF.validateString(x,filter_str_values));
    ips.addParameter('sheenColorWrapS',missing,@(x)gltf.GLTF.validateString(x,wrap_str_values));
    ips.addParameter('sheenColorWrapT',missing,@(x)gltf.GLTF.validateString(x,wrap_str_values));
    ...
    ips.addParameter('sheenRoughnessMagFilter',missing,@(x)gltf.GLTF.validateString(x,filter_str_values));
    ips.addParameter('sheenRoughnessMinFilter',missing,@(x)gltf.GLTF.validateString(x,filter_str_values));
    ips.addParameter('sheenRoughnessWrapS',missing,@(x)gltf.GLTF.validateString(x,wrap_str_values));
    ips.addParameter('sheenRoughnessWrapT',missing,@(x)gltf.GLTF.validateString(x,wrap_str_values));
    ...
    ips.addParameter('specularMagFilter',missing,@(x)gltf.GLTF.validateString(x,filter_str_values));
    ips.addParameter('specularMinFilter',missing,@(x)gltf.GLTF.validateString(x,filter_str_values));
    ips.addParameter('specularWrapS',missing,@(x)gltf.GLTF.validateString(x,wrap_str_values));
    ips.addParameter('specularWrapT',missing,@(x)gltf.GLTF.validateString(x,wrap_str_values));
    ...
    ips.addParameter('specularColorMagFilter',missing,@(x)gltf.GLTF.validateString(x,filter_str_values));
    ips.addParameter('specularColorMinFilter',missing,@(x)gltf.GLTF.validateString(x,filter_str_values));
    ips.addParameter('specularColorWrapS',missing,@(x)gltf.GLTF.validateString(x,wrap_str_values));
    ips.addParameter('specularColorWrapT',missing,@(x)gltf.GLTF.validateString(x,wrap_str_values));
    ...
    ips.addParameter('iridescenceMagFilter',missing,@(x)gltf.GLTF.validateString(x,filter_str_values));
    ips.addParameter('iridescenceMinFilter',missing,@(x)gltf.GLTF.validateString(x,filter_str_values));
    ips.addParameter('iridescenceWrapS',missing,@(x)gltf.GLTF.validateString(x,wrap_str_values));
    ips.addParameter('iridescenceWrapT',missing,@(x)gltf.GLTF.validateString(x,wrap_str_values));
    ...
    ips.addParameter('iridescenceThicknessMagFilter',missing,@(x)gltf.GLTF.validateString(x,filter_str_values));
    ips.addParameter('iridescenceThicknessMinFilter',missing,@(x)gltf.GLTF.validateString(x,filter_str_values));
    ips.addParameter('iridescenceThicknessWrapS',missing,@(x)gltf.GLTF.validateString(x,wrap_str_values));
    ips.addParameter('iridescenceThicknessWrapT',missing,@(x)gltf.GLTF.validateString(x,wrap_str_values));
    ...
    ips.addParameter('anisotropyMagFilter',missing,@(x)gltf.GLTF.validateString(x,filter_str_values));
    ips.addParameter('anisotropyMinFilter',missing,@(x)gltf.GLTF.validateString(x,filter_str_values));
    ips.addParameter('anisotropyWrapS',missing,@(x)gltf.GLTF.validateString(x,wrap_str_values));
    ips.addParameter('anisotropyWrapT',missing,@(x)gltf.GLTF.validateString(x,wrap_str_values));
    ...
    elseif(~ismissing(baseColorTexture))
        if(isnumeric(baseColorTexture))
            material.pbrMetallicRoughness.baseColorTexture=struct('index',obj.addTexture(baseColorTexture));
        elseif(~isnan(baseColorTextureSampler))
            material.pbrMetallicRoughness.baseColorTexture=struct('index',obj.addTexture(baseColorTexture,'sampler',baseColorTextureSampler,'embedTexture',baseColorEmbedTexture));
        else
            material.pbrMetallicRoughness.baseColorTexture=struct('index',obj.addTexture(baseColorTexture,'magFilter',baseColorMagFilter,'minFilter',baseColorMinFilter,'wrapS',baseColorWrapS,'wrapT',baseColorWrapT,'embedTexture',baseColorEmbedTexture));
        end
    end
    ...
    elseif(~ismissing(normalTexture))
        if(isnumeric(normalTexture))
            material.normalTexture=struct('index',obj.addTexture(normalTexture));
        elseif(~isnan(normalTextureSampler))
            material.normalTexture=struct('index',obj.addTexture(normalTexture,'sampler',normalTextureSampler,'embedTexture',normalEmbedTexture));
        else
            material.normalTexture=struct('index',obj.addTexture(normalTexture,'magFilter',normalMagFilter,'minFilter',normalMinFilter,'wrapS',normalWrapS,'wrapT',normalWrapT,'embedTexture',normalEmbedTexture));
        end
    end
    ...
    elseif(~ismissing(occlusionTexture))
        if(isnumeric(occlusionTexture))
            material.occlusionTexture=struct('index',obj.addTexture(occlusionTexture));
        elseif(~isnan(occlusionTextureSampler))
            material.occlusionTexture=struct('index',obj.addTexture(occlusionTexture,'sampler',occlusionTextureSampler,'embedTexture',occlusionEmbedTexture));
        else
            material.occlusionTexture=struct('index',obj.addTexture(occlusionTexture,'magFilter',occlusionMagFilter,'minFilter',occlusionMinFilter,'wrapS',occlusionWrapS,'wrapT',occlusionWrapT,'embedTexture',occlusionEmbedTexture));
        end
    end
    ...
    elseif(~ismissing(metallicRoughnessTexture))
        if(isnumeric(metallicRoughnessTexture))
            material.pbrMetallicRoughness.metallicRoughnessTexture=struct('index',obj.addTexture(metallicRoughnessTexture));
        elseif(~isnan(metallicRoughnessTextureSampler))
            material.pbrMetallicRoughness.metallicRoughnessTexture=struct('index',obj.addTexture(metallicRoughnessTexture,'sampler',metallicRoughnessTextureSampler,'embedTexture',metallicRoughnessEmbedTexture));
        else
            material.pbrMetallicRoughness.metallicRoughnessTexture=struct('index',obj.addTexture(metallicRoughnessTexture,'magFilter',metallicRoughnessMagFilter,'minFilter',metallicRoughnessMinFilter,'wrapS',metallicRoughnessWrapS,'wrapT',metallicRoughnessWrapT,'embedTexture',metallicRoughnessEmbedTexture));
        end
    end
    ...
    elseif(~ismissing(emissiveTexture))
        if(isnumeric(emissiveTexture))
            material.emissiveTexture=struct('index',obj.addTexture(emissiveTexture));
        elseif(~isnan(emissiveTextureSampler))
            material.emissiveTexture=struct('index',obj.addTexture(emissiveTexture,'sampler',emissiveTextureSampler,'embedTexture',emissiveEmbedTexture));
        else
            material.emissiveTexture=struct('index',obj.addTexture(emissiveTexture,'magFilter',emissiveMagFilter,'minFilter',emissiveMinFilter,'wrapS',emissiveWrapS,'wrapT',emissiveWrapT,'embedTexture',emissiveEmbedTexture));
        end
    end
    ...
    if(~ismember("emissiveStrength",ips.UsingDefaults))
        obj.addExtension("KHR_materials_emissive_strength");
    ...
    if(or(~isnan(transmissionTextureIdx),or(~isempty(transmissionFactor),~ismissing(transmissionTexture))))
        obj.addExtension("KHR_materials_transmission");
        ...
        elseif(~ismissing(transmissionTexture))
            if(isnumeric(transmissionTexture))
                KHR_materials_transmission_struct.transmissionTexture=struct('index',obj.addTexture(transmissionTexture));
            elseif(~isnan(transmissionTextureSampler))
                KHR_materials_transmission_struct.transmissionTexture=struct('index',obj.addTexture(transmissionTexture,'sampler',transmissionTextureSampler,'embedTexture',transmissionEmbedTexture));
            else
                KHR_materials_transmission_struct.transmissionTexture=struct('index',obj.addTexture(transmissionTexture,'magFilter',transmissionMagFilter,'minFilter',transmissionMinFilter,'wrapS',transmissionWrapS,'wrapT',transmissionWrapT,'embedTexture',transmissionEmbedTexture));
            end
        end
    ...
    if(~ismember("ior",ips.UsingDefaults))
        obj.addExtension("KHR_materials_ior");
        if(~isempty(ior))
    ...
    if(or(~isnan(thicknessTextureIdx),or(or(~isempty(thicknessFactor),~ismissing(thicknessTexture)),or(~isempty(attenuationDistance),~isempty(attenuationColor)))))
        obj.addExtension("KHR_materials_transmission");
        obj.addExtension("KHR_materials_volume");
        ...
        elseif(~ismissing(thicknessTexture))
            if(isnumeric(thicknessTexture))
                KHR_materials_volume_struct.thicknessTexture=struct('index',obj.addTexture(thicknessTexture));
            elseif(~isnan(thicknessTextureSampler))
                KHR_materials_volume_struct.thicknessTexture=struct('index',obj.addTexture(thicknessTexture,'sampler',thicknessTextureSampler,'embedTexture',thicknessEmbedTexture));
            else
                KHR_materials_volume_struct.thicknessTexture=struct('index',obj.addTexture(thicknessTexture,'magFilter',thicknessMagFilter,'minFilter',thicknessMinFilter,'wrapS',thicknessWrapS,'wrapT',thicknessWrapT,'embedTexture',thicknessEmbedTexture));
            end
        end
    ...
    if(or(or(~isnan(clearcoatTextureIdx),or(~isnan(clearcoatRoughnessTextureIdx),~isnan(clearcoatNormalTextureIdx))),or(or(~isempty(clearcoatFactor),~ismissing(clearcoatTexture)),or(~isempty(clearcoatRoughnessFactor),or(~ismissing(clearcoatRoughnessTexture),~ismissing(clearcoatNormalTexture))))))
        obj.addExtension("KHR_materials_clearcoat");
        ...
        elseif(~ismissing(clearcoatTexture))
            if(isnumeric(clearcoatTexture))
                KHR_materials_clearcoat_struct.clearcoatTexture=struct('index',obj.addTexture(clearcoatTexture));
            elseif(~isnan(clearcoatTextureSampler))
                KHR_materials_clearcoat_struct.clearcoatTexture=struct('index',obj.addTexture(clearcoatTexture,'sampler',clearcoatTextureSampler,'embedTexture',clearcoatEmbedTexture));
            else
                KHR_materials_clearcoat_struct.clearcoatTexture=struct('index',obj.addTexture(clearcoatTexture,'magFilter',clearcoatMagFilter,'minFilter',clearcoatMinFilter,'wrapS',clearcoatWrapS,'wrapT',clearcoatWrapT,'embedTexture',clearcoatEmbedTexture));
            end
        end
        ...
        elseif(~ismissing(clearcoatRoughnessTexture))
            if(isnumeric(clearcoatRoughnessTexture))
                KHR_materials_clearcoat_struct.clearcoatRoughnessTexture=struct('index',obj.addTexture(clearcoatRoughnessTexture));
            elseif(~isnan(clearcoatRoughnessTextureSampler))
                KHR_materials_clearcoat_struct.clearcoatRoughnessTexture=struct('index',obj.addTexture(clearcoatRoughnessTexture,'sampler',clearcoatRoughnessTextureSampler,'embedTexture',clearcoatRoughnessEmbedTexture));
            else
                KHR_materials_clearcoat_struct.clearcoatRoughnessTexture=struct('index',obj.addTexture(clearcoatRoughnessTexture,'magFilter',clearcoatRoughnessMagFilter,'minFilter',clearcoatRoughnessMinFilter,'wrapS',clearcoatRoughnessWrapS,'wrapT',clearcoatRoughnessWrapT,'embedTexture',clearcoatRoughnessEmbedTexture));
            end
        end
        ...
        elseif(~ismissing(clearcoatNormalTexture))
            if(isnumeric(clearcoatNormalTexture))
                KHR_materials_clearcoat_struct.clearcoatNormalTexture=struct('index',obj.addTexture(clearcoatNormalTexture));
            elseif(~isnan(clearcoatNormalTextureSampler))
                KHR_materials_clearcoat_struct.clearcoatNormalTexture=struct('index',obj.addTexture(clearcoatNormalTexture,'sampler',clearcoatNormalTextureSampler,'embedTexture',clearcoatNormalEmbedTexture));
            else
                KHR_materials_clearcoat_struct.clearcoatNormalTexture=struct('index',obj.addTexture(clearcoatNormalTexture,'magFilter',clearcoatNormalMagFilter,'minFilter',clearcoatNormalMinFilter,'wrapS',clearcoatNormalWrapS,'wrapT',clearcoatNormalWrapT,'embedTexture',clearcoatNormalEmbedTexture));
            end
        end
    ...
    if(or(or(~isnan(sheenColorTextureIdx),~isnan(sheenRoughnessTextureIdx)),or(or(~isempty(sheenColorFactor),~ismissing(sheenColorTexture)),or(~isempty(sheenRoughnessFactor),~ismissing(sheenRoughnessTexture)))))
        obj.addExtension("KHR_materials_sheen");
        ...
        elseif(~ismissing(sheenColorTexture))
            if(isnumeric(sheenColorTexture))
                KHR_materials_sheen_struct.sheenColorTexture=struct('index',obj.addTexture(sheenColorTexture));
            elseif(~isnan(sheenColorTextureSampler))
                KHR_materials_sheen_struct.sheenColorTexture=struct('index',obj.addTexture(sheenColorTexture,'sampler',sheenColorTextureSampler,'embedTexture',sheenColorEmbedTexture));
            else
                KHR_materials_sheen_struct.sheenColorTexture=struct('index',obj.addTexture(sheenColorTexture,'magFilter',sheenColorMagFilter,'minFilter',sheenColorMinFilter,'wrapS',sheenColorWrapS,'wrapT',sheenColorWrapT,'embedTexture',sheenColorEmbedTexture));
            end
        end
        ...
        elseif(~ismissing(sheenRoughnessTexture))
            if(isnumeric(sheenRoughnessTexture))
                KHR_materials_sheen_struct.sheenRoughnessTexture=struct('index',obj.addTexture(sheenRoughnessTexture));
            elseif(~isnan(sheenRoughnessTextureSampler))
                KHR_materials_sheen_struct.sheenRoughnessTexture=struct('index',obj.addTexture(sheenRoughnessTexture,'sampler',sheenRoughnessTextureSampler,'embedTexture',sheenRoughnessEmbedTexture));
            else
                KHR_materials_sheen_struct.sheenRoughnessTexture=struct('index',obj.addTexture(sheenRoughnessTexture,'magFilter',sheenRoughnessMagFilter,'minFilter',sheenRoughnessMinFilter,'wrapS',sheenRoughnessWrapS,'wrapT',sheenRoughnessWrapT,'embedTexture',sheenRoughnessEmbedTexture));
            end
        end
    ...
    if(or(or(~isnan(specularTextureIdx),~isnan(specularColorTextureIdx)),or(or(~isempty(specularFactor),~ismissing(specularTexture)),or(~isempty(specularColorFactor),~ismissing(specularColorTexture)))))
        obj.addExtension("KHR_materials_specular");
        ...
        elseif(~ismissing(specularTexture))
            if(isnumeric(specularTexture))
                KHR_materials_specular_struct.specularTexture=struct('index',obj.addTexture(specularTexture));
            elseif(~isnan(specularTextureSampler))
                KHR_materials_specular_struct.specularTexture=struct('index',obj.addTexture(specularTexture,'sampler',specularTextureSampler,'embedTexture',specularEmbedTexture));
            else
                KHR_materials_specular_struct.specularTexture=struct('index',obj.addTexture(specularTexture,'magFilter',specularMagFilter,'minFilter',specularMinFilter,'wrapS',specularWrapS,'wrapT',specularWrapT,'embedTexture',specularEmbedTexture));
            end
        end
        ...
        elseif(~ismissing(specularColorTexture))
            if(isnumeric(specularColorTexture))
                KHR_materials_specular_struct.specularColorTexture=struct('index',obj.addTexture(specularColorTexture));
            elseif(~isnan(specularColorTextureSampler))
                KHR_materials_specular_struct.specularColorTexture=struct('index',obj.addTexture(specularColorTexture,'sampler',specularColorTextureSampler,'embedTexture',specularColorEmbedTexture));
            else
                KHR_materials_specular_struct.specularColorTexture=struct('index',obj.addTexture(specularColorTexture,'magFilter',specularColorMagFilter,'minFilter',specularColorMinFilter,'wrapS',specularColorWrapS,'wrapT',specularColorWrapT,'embedTexture',specularColorEmbedTexture));
            end
        end
    ...
    if(unlit)
        obj.addExtension("KHR_materials_unlit");
    ...
    if(or(or(~isnan(iridescenceTextureIdx),~isnan(iridescenceThicknessTextureIdx)),or(or(~isempty(iridescenceFactor),~ismissing(iridescenceTexture)),or(or(~isempty(iridescenceThicknessMinimum),~isempty(iridescenceThicknessMaximum)),~ismissing(iridescenceThicknessTexture)))))
        obj.addExtension("KHR_materials_iridescence");
        ...
        elseif(~ismissing(iridescenceTexture))
            if(isnumeric(iridescenceTexture))
                KHR_materials_iridescence_struct.iridescenceTexture=struct('index',obj.addTexture(iridescenceTexture));
            elseif(~isnan(iridescenceTextureSampler))
                KHR_materials_iridescence_struct.iridescenceTexture=struct('index',obj.addTexture(iridescenceTexture,'sampler',iridescenceTextureSampler,'embedTexture',iridescenceEmbedTexture));
            else
                KHR_materials_iridescence_struct.iridescenceTexture=struct('index',obj.addTexture(iridescenceTexture,'magFilter',iridescenceMagFilter,'minFilter',iridescenceMinFilter,'wrapS',iridescenceWrapS,'wrapT',iridescenceWrapT,'embedTexture',iridescenceEmbedTexture));
            end
        end
        ...
        elseif(~ismissing(iridescenceThicknessTexture))
            if(isnumeric(iridescenceThicknessTexture))
                KHR_materials_iridescence_struct.iridescenceThicknessTexture=struct('index',obj.addTexture(iridescenceThicknessTexture));
            elseif(~isnan(iridescenceThicknessTextureSampler))
                KHR_materials_iridescence_struct.iridescenceThicknessTexture=struct('index',obj.addTexture(iridescenceThicknessTexture,'sampler',iridescenceThicknessTextureSampler,'embedTexture',iridescenceThicknessEmbedTexture));
            else
                KHR_materials_iridescence_struct.iridescenceThicknessTexture=struct('index',obj.addTexture(iridescenceThicknessTexture,'magFilter',iridescenceThicknessMagFilter,'minFilter',iridescenceThicknessMinFilter,'wrapS',iridescenceThicknessWrapS,'wrapT',iridescenceThicknessWrapT,'embedTexture',iridescenceThicknessEmbedTexture));
            end
        end
    ...
    if(or(or(~isempty(anisotropyStrength),~isempty(anisotropyRotation)),or(~ismissing(anisotropyTexture),~isnan(anisotropyTextureIdx))))
        obj.addExtension("KHR_materials_anisotropy");
        ...
        elseif(~ismissing(anisotropyTexture))
            if(isnumeric(anisotropyTexture))
                KHR_materials_anisotropy_struct.anisotropyTexture=struct('index',obj.addTexture(anisotropyTexture));
            elseif(~isnan(anisotropyTextureSampler))
                KHR_materials_anisotropy_struct.anisotropyTexture=struct('index',obj.addTexture(anisotropyTexture,'sampler',anisotropyTextureSampler,'embedTexture',anisotropyEmbedTexture));
            else
                KHR_materials_anisotropy_struct.anisotropyTexture=struct('index',obj.addTexture(anisotropyTexture,'magFilter',anisotropyMagFilter,'minFilter',anisotropyMinFilter,'wrapS',anisotropyWrapS,'wrapT',anisotropyWrapT,'embedTexture',anisotropyEmbedTexture));
            end
        end
    ...
    if(~isprop(obj,'materials'))
        obj.addprop('materials');
    end
    material_idx=numel(obj.materials);
