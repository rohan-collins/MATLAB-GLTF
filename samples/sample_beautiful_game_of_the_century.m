...
function [obj,piece_node]=ABeautifulGame()
    ...
    chessboard_base=obj.addTexture(url+string(obj_orig.images{obj_orig.textures{obj_orig.materials{obj_orig.meshes{5}.primitives{1}.material+1}.pbrMetallicRoughness.baseColorTexture.index+1}.source+1}.uri),'sampler',sampler_idx);
    chessboard_normal=obj.addTexture(url+string(obj_orig.images{obj_orig.textures{obj_orig.materials{obj_orig.meshes{5}.primitives{1}.material+1}.normalTexture.index+1}.source+1}.uri),'sampler',sampler_idx);
    chessboard_ORM=obj.addTexture(url+string(obj_orig.images{obj_orig.textures{obj_orig.materials{obj_orig.meshes{5}.primitives{1}.material+1}.pbrMetallicRoughness.metallicRoughnessTexture.index+1}.source+1}.uri),'sampler',sampler_idx);
    ...
    castle_white_base=obj.addTexture(url+string(obj_orig.images{obj_orig.textures{obj_orig.materials{obj_orig.meshes{11}.primitives{1}.material+1}.pbrMetallicRoughness.baseColorTexture.index+1}.source+1}.uri),'sampler',sampler_idx);
    castle_black_base=obj.addTexture(url+string(obj_orig.images{obj_orig.textures{obj_orig.materials{obj_orig.meshes{10}.primitives{1}.material+1}.pbrMetallicRoughness.baseColorTexture.index+1}.source+1}.uri),'sampler',sampler_idx);
    castle_normal=obj.addTexture(url+string(obj_orig.images{obj_orig.textures{obj_orig.materials{obj_orig.meshes{10}.primitives{1}.material+1}.normalTexture.index+1}.source+1}.uri),'sampler',sampler_idx);
    castle_ORM=obj.addTexture(url+string(obj_orig.images{obj_orig.textures{obj_orig.materials{obj_orig.meshes{10}.primitives{1}.material+1}.pbrMetallicRoughness.metallicRoughnessTexture.index+1}.source+1}.uri),'sampler',sampler_idx);
    ...
    knight_white_base=obj.addTexture(url+string(obj_orig.images{obj_orig.textures{obj_orig.materials{obj_orig.meshes{13}.primitives{1}.material+1}.pbrMetallicRoughness.baseColorTexture.index+1}.source+1}.uri),'sampler',sampler_idx);
    knight_black_base=obj.addTexture(url+string(obj_orig.images{obj_orig.textures{obj_orig.materials{obj_orig.meshes{12}.primitives{1}.material+1}.pbrMetallicRoughness.baseColorTexture.index+1}.source+1}.uri),'sampler',sampler_idx);
    knight_normal=obj.addTexture(url+string(obj_orig.images{obj_orig.textures{obj_orig.materials{obj_orig.meshes{12}.primitives{1}.material+1}.normalTexture.index+1}.source+1}.uri),'sampler',sampler_idx);
    knight_ORM=obj.addTexture(url+string(obj_orig.images{obj_orig.textures{obj_orig.materials{obj_orig.meshes{12}.primitives{1}.material+1}.pbrMetallicRoughness.metallicRoughnessTexture.index+1}.source+1}.uri),'sampler',sampler_idx);
    ...
    bishop_white_base=obj.addTexture(url+string(obj_orig.images{obj_orig.textures{obj_orig.materials{obj_orig.meshes{15}.primitives{1}.material+1}.pbrMetallicRoughness.baseColorTexture.index+1}.source+1}.uri),'sampler',sampler_idx);
    bishop_black_base=obj.addTexture(url+string(obj_orig.images{obj_orig.textures{obj_orig.materials{obj_orig.meshes{14}.primitives{1}.material+1}.pbrMetallicRoughness.baseColorTexture.index+1}.source+1}.uri),'sampler',sampler_idx);
    bishop_white_normal=obj.addTexture(url+string(obj_orig.images{obj_orig.textures{obj_orig.materials{obj_orig.meshes{15}.primitives{1}.material+1}.normalTexture.index+1}.source+1}.uri),'sampler',sampler_idx);
    bishop_black_normal=obj.addTexture(url+string(obj_orig.images{obj_orig.textures{obj_orig.materials{obj_orig.meshes{14}.primitives{1}.material+1}.normalTexture.index+1}.source+1}.uri),'sampler',sampler_idx);
    bishop_white_ORM=obj.addTexture(url+string(obj_orig.images{obj_orig.textures{obj_orig.materials{obj_orig.meshes{15}.primitives{1}.material+1}.pbrMetallicRoughness.metallicRoughnessTexture.index+1}.source+1}.uri),'sampler',sampler_idx);
    bishop_black_ORM=obj.addTexture(url+string(obj_orig.images{obj_orig.textures{obj_orig.materials{obj_orig.meshes{14}.primitives{1}.material+1}.pbrMetallicRoughness.metallicRoughnessTexture.index+1}.source+1}.uri),'sampler',sampler_idx);
    ...
    queen_white_base=obj.addTexture(url+string(obj_orig.images{obj_orig.textures{obj_orig.materials{obj_orig.meshes{4}.primitives{1}.material+1}.pbrMetallicRoughness.baseColorTexture.index+1}.source+1}.uri),'sampler',sampler_idx);
    queen_black_base=obj.addTexture(url+string(obj_orig.images{obj_orig.textures{obj_orig.materials{obj_orig.meshes{3}.primitives{1}.material+1}.pbrMetallicRoughness.baseColorTexture.index+1}.source+1}.uri),'sampler',sampler_idx);
    queen_white_normal=obj.addTexture(url+string(obj_orig.images{obj_orig.textures{obj_orig.materials{obj_orig.meshes{4}.primitives{1}.material+1}.normalTexture.index+1}.source+1}.uri),'sampler',sampler_idx);
    queen_black_normal=obj.addTexture(url+string(obj_orig.images{obj_orig.textures{obj_orig.materials{obj_orig.meshes{3}.primitives{1}.material+1}.normalTexture.index+1}.source+1}.uri),'sampler',sampler_idx);
    queen_white_ORM=obj.addTexture(url+string(obj_orig.images{obj_orig.textures{obj_orig.materials{obj_orig.meshes{4}.primitives{1}.material+1}.pbrMetallicRoughness.metallicRoughnessTexture.index+1}.source+1}.uri),'sampler',sampler_idx);
    queen_black_ORM=obj.addTexture(url+string(obj_orig.images{obj_orig.textures{obj_orig.materials{obj_orig.meshes{3}.primitives{1}.material+1}.pbrMetallicRoughness.metallicRoughnessTexture.index+1}.source+1}.uri),'sampler',sampler_idx);
    ...
    king_white_base=obj.addTexture(url+string(obj_orig.images{obj_orig.textures{obj_orig.materials{obj_orig.meshes{2}.primitives{1}.material+1}.pbrMetallicRoughness.baseColorTexture.index+1}.source+1}.uri),'sampler',sampler_idx);
    king_black_base=obj.addTexture(url+string(obj_orig.images{obj_orig.textures{obj_orig.materials{obj_orig.meshes{1}.primitives{1}.material+1}.pbrMetallicRoughness.baseColorTexture.index+1}.source+1}.uri),'sampler',sampler_idx);
    king_white_normal=obj.addTexture(url+string(obj_orig.images{obj_orig.textures{obj_orig.materials{obj_orig.meshes{2}.primitives{1}.material+1}.normalTexture.index+1}.source+1}.uri),'sampler',sampler_idx);
    king_black_normal=obj.addTexture(url+string(obj_orig.images{obj_orig.textures{obj_orig.materials{obj_orig.meshes{1}.primitives{1}.material+1}.normalTexture.index+1}.source+1}.uri),'sampler',sampler_idx);
    king_white_ORM=obj.addTexture(url+string(obj_orig.images{obj_orig.textures{obj_orig.materials{obj_orig.meshes{2}.primitives{1}.material+1}.pbrMetallicRoughness.metallicRoughnessTexture.index+1}.source+1}.uri),'sampler',sampler_idx);
    king_black_ORM=obj.addTexture(url+string(obj_orig.images{obj_orig.textures{obj_orig.materials{obj_orig.meshes{1}.primitives{1}.material+1}.pbrMetallicRoughness.metallicRoughnessTexture.index+1}.source+1}.uri),'sampler',sampler_idx);
    ...
    pawn_white_base=obj.addTexture(url+string(obj_orig.images{obj_orig.textures{obj_orig.materials{obj_orig.meshes{7}.primitives{1}.material+1}.pbrMetallicRoughness.baseColorTexture.index+1}.source+1}.uri),'sampler',sampler_idx);
    pawn_black_base=obj.addTexture(url+string(obj_orig.images{obj_orig.textures{obj_orig.materials{obj_orig.meshes{9}.primitives{1}.material+1}.pbrMetallicRoughness.baseColorTexture.index+1}.source+1}.uri),'sampler',sampler_idx);
    pawn_normal=obj.addTexture(url+string(obj_orig.images{obj_orig.textures{obj_orig.materials{obj_orig.meshes{7}.primitives{1}.material+1}.normalTexture.index+1}.source+1}.uri),'sampler',sampler_idx);
    pawn_ORM=obj.addTexture(url+string(obj_orig.images{obj_orig.textures{obj_orig.materials{obj_orig.meshes{7}.primitives{1}.material+1}.pbrMetallicRoughness.metallicRoughnessTexture.index+1}.source+1}.uri),'sampler',sampler_idx);
    ...
    piece_mesh(pieces=="a2",1)=obj.addMesh(VP,'indices',FP,'NORMAL',NP,'material',pawn_white_mat,'TEXCOORD',UVP,'WEIGHTS',W(VP),'JOINTS',J(VP));
    % Add pawn top mesh.
    obj.addPrimitiveToMesh(piece_mesh(pieces=="a2",1),VP2,'indices',FP2,'NORMAL',NP2,'material',pawn_white_top_mat,'TEXCOORD',UVP2,'WEIGHTS',W(VP2),'JOINTS',J(VP2));
    ...
    piece_node(positions=="a2")=obj.addNode('addToScene',false,'translation',[X(positions=="a2") 0 Z(positions=="a2")]);
    obj.addNode('mesh',piece_mesh(pieces==position_piece("a2"==positions)),'skin',obj.addSkin(piece_node(positions=="a2"),'inverseBindMatrices',ibm),'children',piece_node(positions=="a2"));
    piece_node(positions=="b2")=obj.addNode('addToScene',false,'translation',[X(positions=="b2") 0 Z(positions=="b2")]);
    obj.addNode('mesh',piece_mesh(pieces==position_piece("a2"==positions)),'skin',obj.addSkin(piece_node(positions=="b2"),'inverseBindMatrices',ibm),'children',piece_node(positions=="b2"));
    piece_node(positions=="c2")=obj.addNode('addToScene',false,'translation',[X(positions=="c2") 0 Z(positions=="c2")]);
    obj.addNode('mesh',piece_mesh(pieces==position_piece("a2"==positions)),'skin',obj.addSkin(piece_node(positions=="c2"),'inverseBindMatrices',ibm),'children',piece_node(positions=="c2"));
    piece_node(positions=="d2")=obj.addNode('addToScene',false,'translation',[X(positions=="d2") 0 Z(positions=="d2")]);
    obj.addNode('mesh',piece_mesh(pieces==position_piece("a2"==positions)),'skin',obj.addSkin(piece_node(positions=="d2"),'inverseBindMatrices',ibm),'children',piece_node(positions=="d2"));
    piece_node(positions=="e2")=obj.addNode('addToScene',false,'translation',[X(positions=="e2") 0 Z(positions=="e2")]);
    obj.addNode('mesh',piece_mesh(pieces==position_piece("a2"==positions)),'skin',obj.addSkin(piece_node(positions=="e2"),'inverseBindMatrices',ibm),'children',piece_node(positions=="e2"));
    piece_node(positions=="f2")=obj.addNode('addToScene',false,'translation',[X(positions=="f2") 0 Z(positions=="f2")]);
    obj.addNode('mesh',piece_mesh(pieces==position_piece("a2"==positions)),'skin',obj.addSkin(piece_node(positions=="f2"),'inverseBindMatrices',ibm),'children',piece_node(positions=="f2"));
    piece_node(positions=="g2")=obj.addNode('addToScene',false,'translation',[X(positions=="g2") 0 Z(positions=="g2")]);
    obj.addNode('mesh',piece_mesh(pieces==position_piece("a2"==positions)),'skin',obj.addSkin(piece_node(positions=="g2"),'inverseBindMatrices',ibm),'children',piece_node(positions=="g2"));
    piece_node(positions=="h2")=obj.addNode('addToScene',false,'translation',[X(positions=="h2") 0 Z(positions=="h2")]);
    obj.addNode('mesh',piece_mesh(pieces==position_piece("a2"==positions)),'skin',obj.addSkin(piece_node(positions=="h2"),'inverseBindMatrices',ibm),'children',piece_node(positions=="h2"));
    piece_node(positions=="a7")=obj.addNode('addToScene',false,'translation',[X(positions=="a7") 0 Z(positions=="a7")],'rotation',[0 1 0 0]);
    obj.addNode('mesh',piece_mesh(pieces==position_piece("a7"==positions)),'skin',obj.addSkin(piece_node(positions=="a7"),'inverseBindMatrices',ibm),'children',piece_node(positions=="a7"));
    piece_node(positions=="b7")=obj.addNode('addToScene',false,'translation',[X(positions=="b7") 0 Z(positions=="b7")],'rotation',[0 1 0 0]);
    obj.addNode('mesh',piece_mesh(pieces==position_piece("a7"==positions)),'skin',obj.addSkin(piece_node(positions=="b7"),'inverseBindMatrices',ibm),'children',piece_node(positions=="b7"));
    piece_node(positions=="c7")=obj.addNode('addToScene',false,'translation',[X(positions=="c7") 0 Z(positions=="c7")],'rotation',[0 1 0 0]);
    obj.addNode('mesh',piece_mesh(pieces==position_piece("a7"==positions)),'skin',obj.addSkin(piece_node(positions=="c7"),'inverseBindMatrices',ibm),'children',piece_node(positions=="c7"));
    piece_node(positions=="d7")=obj.addNode('addToScene',false,'translation',[X(positions=="d7") 0 Z(positions=="d7")],'rotation',[0 1 0 0]);
    obj.addNode('mesh',piece_mesh(pieces==position_piece("a7"==positions)),'skin',obj.addSkin(piece_node(positions=="d7"),'inverseBindMatrices',ibm),'children',piece_node(positions=="d7"));
    piece_node(positions=="e7")=obj.addNode('addToScene',false,'translation',[X(positions=="e7") 0 Z(positions=="e7")],'rotation',[0 1 0 0]);
    obj.addNode('mesh',piece_mesh(pieces==position_piece("a7"==positions)),'skin',obj.addSkin(piece_node(positions=="e7"),'inverseBindMatrices',ibm),'children',piece_node(positions=="e7"));
    piece_node(positions=="f7")=obj.addNode('addToScene',false,'translation',[X(positions=="f7") 0 Z(positions=="f7")],'rotation',[0 1 0 0]);
    obj.addNode('mesh',piece_mesh(pieces==position_piece("a7"==positions)),'skin',obj.addSkin(piece_node(positions=="f7"),'inverseBindMatrices',ibm),'children',piece_node(positions=="f7"));
    piece_node(positions=="g7")=obj.addNode('addToScene',false,'translation',[X(positions=="g7") 0 Z(positions=="g7")],'rotation',[0 1 0 0]);
    obj.addNode('mesh',piece_mesh(pieces==position_piece("a7"==positions)),'skin',obj.addSkin(piece_node(positions=="g7"),'inverseBindMatrices',ibm),'children',piece_node(positions=="g7"));
    piece_node(positions=="h7")=obj.addNode('addToScene',false,'translation',[X(positions=="h7") 0 Z(positions=="h7")],'rotation',[0 1 0 0]);
    obj.addNode('mesh',piece_mesh(pieces==position_piece("a7"==positions)),'skin',obj.addSkin(piece_node(positions=="h7"),'inverseBindMatrices',ibm),'children',piece_node(positions=="h7"));
end
